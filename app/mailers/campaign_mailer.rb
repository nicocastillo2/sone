class CampaignMailer < ApplicationMailer
  ...
  def change_subscription(subscription_name, user_email)
    ...
    mail(to: @user_email, subject: I18n.t("mailers.campaign.change_subscription.subject"), from: 'noreply@sone-app.com', sparkpost_data: data)
  end

  def welcome(user)
    @current_user = user
    data = { html_content_only: true }
    mail(to: @current_user.email, subject: I18n.t("mailers.campaign.welcome.subject"), from: 'noreply@sone-app.com', sparkpost_data: data)
  end
